...
if [ $# -lt 7 ]; then
	echo "Usage: `basename $0` directory maxOperatorCost operatorCount pipelineSplitEnabled? regionRebalanceEnabled? pipelineSplitFirst? metricsReadingPeriod"
	exit 1
fi
