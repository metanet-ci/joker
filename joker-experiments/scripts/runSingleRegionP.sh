...
if [ $# -lt 9 ]; then
	echo "Usage: `basename $0` directory maxOperatorCost operatorCount pipelineSplitEnabled? regionRebalanceEnabled? pipelineSplitFirst? metricsReadingPeriod warmUpPeriods historySize"
	exit 1
fi
