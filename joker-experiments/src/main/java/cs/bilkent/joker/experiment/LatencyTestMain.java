...
public class LatencyTestMain
{
    ...
    public static final String ENFORCE_THREAD_AFFINITY = "enforceThreadAffinity";
    ...
    public static void main ( String[] args ) throws ExecutionException, InterruptedException, TimeoutException
    {
        ...
        final boolean shouldEnforceThreadAffinity = config.hasPath( ENFORCE_THREAD_AFFINITY );
        ...
        configBuilder.getPipelineReplicaRunnerConfigBuilder().enforceThreadAffinity( shouldEnforceThreadAffinity );
