...
public class ModelComparisonFlowDefFactory2 implements FlowDefFactory
{
    ...
    public FlowDef createFlow ( final JokerConfig jokerConfig )
    {
        ...
        final Supplier<Predicate<Tuple>> predicateSupplier1 = () -> new SelectivityConfigurablePredicate( multiplier1Id,
                                                                                                          selectivity1,
                                                                                                          period,
                                                                                                          multiplicationCount1 );
        final Supplier<Predicate<Tuple>> predicateSupplier2 = () -> new SelectivityConfigurablePredicate( multiplier2Id,
                                                                                                          selectivity2,
                                                                                                          period,
                                                                                                          multiplicationCount2 );
        final Supplier<Predicate<Tuple>> predicateSupplier3 = () -> new SelectivityConfigurablePredicate( multiplier3Id,
                                                                                                          selectivity3,
                                                                                                          period,
                                                                                                          multiplicationCount3 );
        final Supplier<Predicate<Tuple>> predicateSupplier4 = () -> new SelectivityConfigurablePredicate( multiplier4Id,
                                                                                                          selectivity4,
                                                                                                          period,
                                                                                                          multiplicationCount4 );
        final Supplier<Predicate<Tuple>> predicateSupplier5 = () -> new SelectivityConfigurablePredicate( multiplier5Id,
                                                                                                          selectivity5,
                                                                                                          period,
                                                                                                          multiplicationCount5 );
        final Supplier<Predicate<Tuple>> predicateSupplier6 = () -> new SelectivityConfigurablePredicate( multiplier6Id,
                                                                                                          selectivity6,
                                                                                                          period,
                                                                                                          multiplicationCount6 );
        final Supplier<Predicate<Tuple>> predicateSupplier7 = () -> new SelectivityConfigurablePredicate( multiplier7Id,
                                                                                                          selectivity7,
                                                                                                          period,
        ...
        final OperatorConfig multiplierConfig1 = new OperatorConfig().set( FilterOperator.PREDICATE_CONFIG_PARAMETER, predicateSupplier1 );

        final OperatorDef multiplier1 = OperatorDefBuilder.newInstance( multiplier1Id, FilterOperator.class )
