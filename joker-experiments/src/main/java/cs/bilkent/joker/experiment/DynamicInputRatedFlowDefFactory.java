...
import cs.bilkent.joker.experiment.dynamicinputrate.DynamicInputRatedBeaconOperator;
import static cs.bilkent.joker.experiment.dynamicinputrate.DynamicInputRatedBeaconOperator.PERIOD_IN_MILLIS_CONFIG_PARAMETER;
import static cs.bilkent.joker.experiment.dynamicinputrate.DynamicInputRatedBeaconOperator.TOKEN_COUNT_CONFIG_PARAMETER;
...
public class DynamicInputRatedFlowDefFactory implements FlowDefFactory
{
    ...
    public FlowDef createFlow ( final JokerConfig jokerConfig )
    {
        ...
        final int tokenCount = config.getInt( "tokenCount" );
        final long periodInMillis = config.getLong( "periodInMillis" );
