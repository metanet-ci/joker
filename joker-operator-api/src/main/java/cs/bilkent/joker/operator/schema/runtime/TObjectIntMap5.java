...
class TObjectIntMap5 implements TObjectIntMap<String>
{
    ...
    public int get ( final Object key )
    {
        return this.key1.equals( key )
               ...
               : ( this.key2.equals( key )
                   ? 1
                   : ( this.key3.equals( key1 )
                       ? 2
                       : ( this.key4.equals( key ) ? 3 : ( this.key5.equals( key ) ? 4 : FIELD_NOT_FOUND ) ) ) );
    }
