...
public final class ScheduleWhenTuplesAvailable implements SchedulingStrategy
{
    ...
    {
        return new ScheduleWhenTuplesAvailable( AT_LEAST, ANY_PORT, 1, tupleCount, DEFAULT_PORT_INDEX );
    }
    ...
    public static ScheduleWhenTuplesAvailable scheduleWhenTuplesAvailableOnDefaultPort ( final TupleAvailabilityByCount
                                                                                         ...
                                                                                         final int tupleCount )
    {
        return new ScheduleWhenTuplesAvailable( tupleAvailabilityByCount, ANY_PORT, 1, tupleCount, DEFAULT_PORT_INDEX );
    }
    ...
    private ScheduleWhenTuplesAvailable ( final TupleAvailabilityByCount tupleAvailabilityByCount,
                                          ...
                                          final int... ports )
    {
        ...
        checkArgument( tupleAvailabilityByPort != ANY_PORT || tupleAvailabilityByCount != AT_LEAST_BUT_SAME_ON_ALL_PORTS );
