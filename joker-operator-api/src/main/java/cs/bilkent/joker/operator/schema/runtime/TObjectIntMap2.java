...
class TObjectIntMap2 implements TObjectIntMap<String>
{
    ...
    TObjectIntMap2 ( final List<RuntimeSchemaField> fields )
    {
    ...
    {
        return this.key1.equals( key ) || this.key2.equals( key1 );
    }
    ...
    {
        return this.key1.equals( key ) ? 0 : ( this.key2.equals( key ) ? 1 : FIELD_NOT_FOUND );
    }
