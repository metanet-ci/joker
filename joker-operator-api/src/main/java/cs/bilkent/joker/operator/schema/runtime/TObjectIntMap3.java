...
class TObjectIntMap3 implements TObjectIntMap<String>
{
    ...
    TObjectIntMap3 ( final List<RuntimeSchemaField> fields )
    {
        checkArgument( fields.size() == 3 );
    ...
    {
        return this.key1.equals( key ) || this.key2.equals( key1 ) || this.key3.equals( key1 );
    }
    ...
    {
        return this.key1.equals( key ) ? 0 : ( this.key2.equals( key ) ? 1 : ( this.key3.equals( key1 ) ? 2 : FIELD_NOT_FOUND ) );
    }
