...
public class BargainIndexOperatorTest
{
    ...
    public void shouldReturnOutputsFromQuotesWithUpToDateVWAPs ()
    {
        ...
        assertThat( outputTuples.getTuple( DEFAULT_PORT_INDEX, 0 ).get( BARGAIN_INDEX_FIELD ), equalTo( Math.exp( 10 ) ) );
        assertThat( outputTuples.getTuple( DEFAULT_PORT_INDEX, 1 ).get( BARGAIN_INDEX_FIELD ), equalTo( Math.exp( 30 ) * 2 ) );
