...
public class RegionManager
{
    ...
    private KVStoreContextManager kvStoreContextManager;

    private TupleQueueContextManager tupleQueueContextManager;

    private final Map<Integer, RegionInstance> regions = new HashMap<>();

    public void setKvStoreContextManager ( final KVStoreContextManager kvStoreContextManager )
    {
        this.kvStoreContextManager = kvStoreContextManager;
    }

    public void setTupleQueueContextManager ( final TupleQueueContextManager tupleQueueContextManager )
    {
