...
import static cs.bilkent.joker.engine.util.RegionUtils.getLastOperator;
import static cs.bilkent.joker.engine.util.RegionUtils.getRegionByLastOperator;
import static cs.bilkent.joker.engine.util.RegionUtils.sortTopologically;
